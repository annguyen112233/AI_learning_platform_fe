...
export default function MyCourses() {
  ...
  // Tách khóa học đang học gần nhất để hiển thị nổi bật
        ...
        <section>
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col md:flex-row gap-8 items-center">
             <div className="w-full md:w-1/3 aspect-video rounded-2xl overflow-hidden relative group shadow-md">
                <img src={lastActiveCourse.image} alt="Cover" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
             ...
             <div className="flex-1 w-full space-y-4">
                ...
                <div className="pt-2">
                   <Button size="lg" onClick={() => navigate(`/student/learning/${lastActiveCourse.id}`)}>
